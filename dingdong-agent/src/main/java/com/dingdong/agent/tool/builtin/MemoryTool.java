...
import com.dingdong.agent.memory.MemoryStore.CandidateMemory;
...
@Slf4j
@Component
@ConditionalOnProperty(prefix = "dingdong.memory", name = "enabled", havingValue = "true", matchIfMissing = true)
