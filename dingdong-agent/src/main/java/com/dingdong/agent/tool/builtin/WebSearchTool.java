...
@Slf4j
@Component
@ConditionalOnProperty(prefix = "dingdong.agent.builtin.web-search", name = "enabled", havingValue = "true", matchIfMissing = true)
public class WebSearchTool {

    private static final int MAX_RESULTS = 5;

    @Value("${dingdong.agent.builtin.web-search.instance:http://154.201.84.30:18080}")
    private String searxInstance;

    @Value("${dingdong.agent.builtin.web-search.result-count:5}")
